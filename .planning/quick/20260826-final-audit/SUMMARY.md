...
- Finder 文件关联注册了常见文本、图片和 PDF 类型；初次启动和第二次启动路径都会进入唯一实例的打开流程。
- 设置与跨标签查找支持 `Esc` 关闭并恢复原焦点。
...
- GitHub CI `32907715868` 和 Release `32908022700` 成功，`v0.1.11` 正式发布并包含 arm64 DMG/App 资产。
- GitHub CI `32908516631` 和 Release `32908770669` 成功，`v0.1.12` 正式发布并包含 arm64 DMG/App 资产。
