...
const zhCN = {
  ...
  save: '保存', saveActiveTitle: '保存当前标签（⌘S）', split: '分区', addSplitTitle: '新建编辑分区（最多两个）', toggleSplitTitle: '切换分区方向',
  splitHorizontal: '上下分区', splitVertical: '左右分区', merge: '合并', mergeTitle: '合并当前编辑分区', search: '查找', searchTitle: '跨标签查找（⌘⇧F）',
  settings: '设置', pin: '固定面板', unpin: '取消固定', tabsAria: '编辑标签', previewSuffix: '预览', closeTabAria: '关闭 {name}',
  tabDragHint: '（双击重命名，可拖到其他分区）', restoreClosed: '撤销关闭', expired: '超时', closed: '关闭', noUndo: '没有撤销记录',
  workspaceAria: '临时编辑区', groupAria: '编辑分区 {id}', newGroupTab: '新建分区标签', nativeReady: '原生面板已连接', nativeConnecting: '正在连接原生面板…',
  ...
  vimEditor: 'Vim（编辑区）', edgeModifier: '边缘呼出修饰键', commandKey: 'Command（⌘）', optionKey: 'Option（⌥）', controlKey: 'Control（⌃）', shiftKey: 'Shift（⇧）',
  tabLayout: '标签布局', tabTop: '顶部横向滚动', tabLeft: '左侧标签', tabRight: '右侧标签', splitRatio: '分区比例', customShortcuts: '自定义编辑器快捷键',
  shortcutPlaceholder: '留空使用方案默认值', shortcutAria: '{name}快捷键', fontSize: '编辑器字号', editorRegion: '编辑器区域', lineNumbers: '行号', minimap: 'Minimap',
  folding: '代码折叠', glyphMargin: '字形边栏', preserveRestart: '重启后恢复最后工作状态', showMenuBar: '显示菜单栏图标', showDock: '显示 Dock 图标',
  launchAtLogin: '登录时启动 Edgedor', expiryNote: '临时标签 24 小时未访问会过期，并进入可撤销槽。文件只有触发保存时才写回原路径。',
  clearWorkspace: '清空标签和撤销槽', done: '完成', selectNextOccurrence: '逐个选择相同内容', selectAllOccurrences: '选择所有相同内容',
  ...
  invalidShortcut: '快捷键格式无效，例如 Cmd+Shift+L', dockSettingFailed: 'Dock 图标设置失败：', loginSettingFailed: '登录启动设置失败：',
  modifierChanged: '边缘触发键已改为 {modifier}', nativeTriggerUnavailable: '设置已保存，原生边缘触发接口尚未连接', previewRefreshed: '{name} 已刷新',
  refreshFailed: '刷新失败：', clearConfirm: '清空所有标签和撤销槽？真实文件不会被删除。', workspaceCleared: '工作区已清空', splitLimit: '当前版本支持两个编辑分区',
...
const en: Record<keyof typeof zhCN, string> = {
  ...
  save: 'Save', saveActiveTitle: 'Save active tab (⌘S)', split: 'Split', addSplitTitle: 'Create editor group (maximum two)', toggleSplitTitle: 'Switch split direction',
  ...
  settings: 'Settings', pin: 'Pin Panel', unpin: 'Unpin', tabsAria: 'Editor tabs', previewSuffix: 'Preview', closeTabAria: 'Close {name}',
  ...
  workspaceAria: 'Temporary editor workspace', groupAria: 'Editor group {id}', newGroupTab: 'New Group Tab', nativeReady: 'Native panel connected', nativeConnecting: 'Connecting native panel…',
  ...
  vimEditor: 'Vim (editor)', edgeModifier: 'Edge trigger modifier', commandKey: 'Command (⌘)', optionKey: 'Option (⌥)', controlKey: 'Control (⌃)', shiftKey: 'Shift (⇧)',
  tabLayout: 'Tab layout', tabTop: 'Top, horizontal scrolling', tabLeft: 'Tabs on left', tabRight: 'Tabs on right', splitRatio: 'Split ratio', customShortcuts: 'Custom editor shortcuts',
  ...
  folding: 'Code folding', glyphMargin: 'Glyph margin', preserveRestart: 'Restore last workspace after restart', showMenuBar: 'Show menu bar icon', showDock: 'Show Dock icon',
  ...
  clearWorkspace: 'Clear Tabs and Undo Slots', done: 'Done', selectNextOccurrence: 'Select next occurrence', selectAllOccurrences: 'Select all occurrences',
  ...
  invalidShortcut: 'Invalid shortcut. Example: Cmd+Shift+L', dockSettingFailed: 'Could not update Dock icon setting: ', loginSettingFailed: 'Could not update login item: ',
  ...
  refreshFailed: 'Refresh failed: ', clearConfirm: 'Clear all tabs and undo slots? Original files will not be deleted.', workspaceCleared: 'Workspace cleared', splitLimit: 'This version supports two editor groups',
