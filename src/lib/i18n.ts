...
const zhCN = {
  ...
  folding: '代码折叠', glyphMargin: '字形边栏', breadcrumbs: '面包屑', statusBar: '编辑器状态栏', languageMode: '语言模式', preserveRestart: '重启后恢复最后工作状态', showMenuBar: '显示菜单栏图标', showDock: '显示 Dock 图标',
  launchAtLogin: '登录时启动 Edgedor', expiryNote: '临时标签 24 小时未访问会过期，并进入可撤销槽。文件只有触发保存时才写回原路径。',
  clearWorkspace: '清空标签和撤销槽', checkUpdates: '检查更新', noUpdates: '已是最新版本', updateFound: '发现新版本 {version}，现在安装？', updateFailed: '检查更新失败：', done: '完成', selectNextOccurrence: '逐个选择相同内容', selectAllOccurrences: '选择所有相同内容',
...
const en: Record<keyof typeof zhCN, string> = {
  ...
  folding: 'Code folding', glyphMargin: 'Glyph margin', breadcrumbs: 'Breadcrumbs', statusBar: 'Editor status bar', languageMode: 'Language mode', preserveRestart: 'Restore last workspace after restart', showMenuBar: 'Show menu bar icon', showDock: 'Show Dock icon',
  ...
  clearWorkspace: 'Clear Tabs and Undo Slots', checkUpdates: 'Check for Updates', noUpdates: 'Edgedor is up to date', updateFound: 'Version {version} is available. Install now?', updateFailed: 'Update check failed: ', done: 'Done', selectNextOccurrence: 'Select next occurrence', selectAllOccurrences: 'Select all occurrences',
