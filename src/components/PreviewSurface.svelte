...
<style>
  ...
  .refresh { position: absolute; right: 12px; top: 12px; border: 0; border-radius: 7px; padding: 5px 8px; color: var(--text); background: color-mix(in srgb, var(--panel) 88%, var(--text)); }
</style>
